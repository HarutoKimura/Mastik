...
plt.plot(df['Slot'], df['Square'], 'r.', label='Square', markersize=5)
plt.plot(df['Slot'], df['Multiply'], 'g.', label='Multiply', markersize=5)
plt.plot(df['Slot'], df['Reduce'], 'b.', label='Reduce', markersize=5)
